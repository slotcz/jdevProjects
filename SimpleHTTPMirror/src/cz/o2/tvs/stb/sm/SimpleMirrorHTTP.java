...
public class SimpleMirrorHTTP {
    public SimpleMirrorHTTP() {
        super();
    }

    public static void main(String[] args) {
        SimpleMirrorHTTP simpleMirrorHTTP = new SimpleMirrorHTTP();
        int port = 8585;
        if (args.length > 0) {
